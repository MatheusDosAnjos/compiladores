...
static const map<ErrorType, string> errorTemplates = {
    ...
    {ErrorType::INCOMPATIBLE_INIT, "Type '{0}' is not compatible with '{1}' on '{2}' initialization."},
    {ErrorType::UNDECLARED_VARIABLE, "Variable '{0}' undeclared."},
    {ErrorType::INVALID_ARRAY_SIZE, "'{0}' array declaration size must be greater than 0."},
    ...
    {ErrorType::INVALID_FUNCTION_CALL, "Function '{0}' called with wrong number of arguments."},
    ...
    {ErrorType::INCOMPATIBLE_ASSIGN, "Type '{0}' is not compatible with '{1}' on '{2}' assignment."},
};
